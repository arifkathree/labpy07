...
- Menambahkan Data dengan input `1`
![IMG7](ss/5.png)
- Menampilan Data dengan input `2`
![IMG6](ss/6.png)
- Mengubah Data dengan input `3`
![IMG8](ss/7.png)
- Menghapus Data dengan input `4`
![IMG9](ss/8.png)
- Keluar dari program denga input `5`
![IMG3](ss/9.png)
